...
class Page {
  ...
  @override
  String toString() => 'Page[content=$content, totalElements=$totalElements, totalPages=$totalPages, last=$last, first=$first, numberOfElements=$numberOfElements, empty=$empty]';
  ...
  static Page? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Page(
        // content: (json[r'content'] as List<dynamic>).cast<String>(),
