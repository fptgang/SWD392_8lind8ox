...
// tests for GetOrderDetails200Response
void main() {
  // final instance = GetOrderDetails200Response();

  group('test GetOrderDetails200Response', () {
    // List<OrderDetailDto> content (default value: const [])
