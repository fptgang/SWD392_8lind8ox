...
class CartScreen extends StatelessWidget {
  ...
  Widget _buildSelectAllRow(BuildContext context, CartState state) {
    final bool allSelected = state.items.length == state.selectedItemIds.length && state.items.isNotEmpty;
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          ElevatedButton(
            onPressed: state.selectedItemIds.isNotEmpty ? () => _proceedToCheckout(context) : null,
            ...
            child: Text(
              ...
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: getColorSkin().white),
            ),
          ),
        ],
      ),
