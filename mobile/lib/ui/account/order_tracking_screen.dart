...
class OrderDetailScreen extends StatelessWidget {
  ...
  static Route<void> route(String orderId, OrderStatusEnum status) {
    return MaterialPageRoute<void>(builder: (_) => OrderDetailScreen(orderId: orderId, status: status));
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildTimeline(OrderStatusEnum.CREATED, "Order Placed", "Dec 20, 2019",
          ...
          _buildTimeline(OrderStatusEnum.PREPARING, "Processing", "Dec 21, 2019",
              status == OrderStatusEnum.PREPARING ||
                  status == OrderStatusEnum.SHIPPING ||
                  status == OrderStatusEnum.DELIVERED ||
                  status == OrderStatusEnum.RECEIVED ||
                  status == OrderStatusEnum.COMPLETED),
          _buildTimeline(OrderStatusEnum.SHIPPING, "Shipped", "Dec 22, 2019",
              status == OrderStatusEnum.SHIPPING ||
                  status == OrderStatusEnum.DELIVERED ||
                  status == OrderStatusEnum.RECEIVED ||
                  status == OrderStatusEnum.COMPLETED),
          _buildTimeline(OrderStatusEnum.DELIVERED, "Delivered", "Dec 31, 2019",
              status == OrderStatusEnum.DELIVERED ||
                  status == OrderStatusEnum.RECEIVED ||
                  status == OrderStatusEnum.COMPLETED,
              isLast: true),
  ...
  Widget _buildTimeline(OrderStatusEnum timelineStatus, String title, String date, bool isCompleted, {bool isLast = false}) {
    return SizedBox(
      height: 70,
      child: TimelineTile(
        ...
        afterLineStyle: LineStyle(
          color: status == timelineStatus || !isCompleted ? Colors.grey.shade300 : Colors.green,
        ),
        endChild: Padding(
  ...
  Widget _buildOrderItem(String name, String quantity, String price, String emoji) {
    return Padding(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          status == OrderStatusEnum.DELIVERED ? "Delivered" : "Est. Delivery Dec 31",
                          style: TextStyle(
                            color: status == OrderStatusEnum.DELIVERED ? Colors.green : Colors.blue,
                            fontWeight: FontWeight.w500,
                          ),
                        ),
                      ],
