...
class _ImageCarouselState extends State<ImageCarousel> with AutomaticKeepAliveClientMixin {
  @override
  void initState() {
    super.initState();
  ...
  void didUpdateWidget(ImageCarousel oldWidget) {
    ...
    if (oldWidget.state.selectedImageIndex != widget.state.selectedImageIndex &&
        widget.pageController.hasClients &&
        widget.pageController.page?.round() != widget.state.selectedImageIndex) {
