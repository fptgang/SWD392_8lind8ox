...
import 'package:mobile/feature/auth/register/blocs/register_bloc.dart';
import 'package:mobile/feature/auth/register/blocs/register_event.dart';
import 'package:mobile/feature/auth/register/blocs/register_state.dart';
                ...
                children: [
                  Flexible(
                    child: ElevatedButton.icon(
                      ...
                      icon:
                          Icon(Icons.g_mobiledata, color: getColorSkin().black),
                      label: FittedBox(
                        child: Text(
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        errorText: displayError != null
            ? AppLocalizations.of(context)!.invalidFirstName
            : null,
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
        ),
  ...
  Widget build(BuildContext context) {
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        errorText: displayError != null
            ? AppLocalizations.of(context)!.invalidLastName
            : null,
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
        ),
