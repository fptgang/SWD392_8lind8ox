...
import 'package:mobile/feature/auth/reset_password/blocs/reset_password_event.dart';
import 'package:mobile/feature/auth/reset_password/blocs/reset_password_state.dart';
...
class ResetPasswordBloc extends Bloc<ResetPasswordEvent, ResetPasswordState> {
  ...
  void _onEmailChanged(
      ResetPasswordEmailChanged event, Emitter<ResetPasswordState> emit) {
  ...
  void _onPasswordChanged(
    ...
    emit(state.copyWith(
      password: password,
      isValid:
          password.isValid && (password.value == state.confirmPassword.value),
    ));
  }
  ...
  void _onConfirmPasswordChanged(
    ...
    emit(state.copyWith(
      ...
      isValid: confirmPassword.value == state.password.value &&
          state.password.isValid,
    ));
  }

  void _onForgotPassword(
      ForgotPassword event, Emitter<ResetPasswordState> emit) async {
    final email = state.email.value;
    try {
      debugPrint('on Forgot password');
      final ForgotPasswordRequestDto forgotPasswordRequestDto =
  ...
  void _onResetPasswordResponse(
      ResetPasswordResponse event, Emitter<ResetPasswordState> emit) {
