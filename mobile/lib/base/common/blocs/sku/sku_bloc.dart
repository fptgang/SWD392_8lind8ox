...
import 'package:mobile/base/common/blocs/sku/sku_event.dart';
import 'package:mobile/base/common/blocs/sku/sku_state.dart';
...
@injectable
@lazySingleton
class StockKeepingUnitsBloc
    extends Bloc<StockKeepingUnitEvent, StockKeepingUnitsState> {
  ...
  StockKeepingUnitsBloc(
    ...
    this._imageRepository,
            ...
            SkuPaginationState(pageable: Pageable(page: 1, size: 20)),
    ...
    try {
      ...
      if (isLastPage) {
        ...
        pagingController.appendPage(
            stockKeepingUnits.content, event.pageKey + 1);
      }
  ...
  Future<void> _onGetNewReleaseStockKeepingUnits(
    ...
    try {
      ...
      final ImageModel imageModel = await _imageRepository
          .getImageById(stockKeepingUnits.content[0].image?.imageId ?? 1);
      ...
      _dataState =
          _dataState.copyWith(skus: stockKeepingUnits, imageUrl: imageUrl);
      emit(_dataState);
    } catch (e) {
