  ...
  Future<PaginationResponseGeneric<PromotionModel>> getPromotions(Pageable pageable, String filter, String search) async {
    try{
      ...
      try {
        ...
        // Log success
        debugPrint('Successfully mapped ${promotionModels.content.length} promotions');
      ...
      throw Exception('[PromotionRepositoryImpl]: Cannot get promotion information, error: $e, stacktrace: $stackTrace');
    }
  }
